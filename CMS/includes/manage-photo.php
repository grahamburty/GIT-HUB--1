...
<script src="http://<?php echo $_SERVER['HTTP_HOST'] ?>/<?php echo $pulse_dir?>/plugins/jquery/jquery_ui.js"></script>
	...
	$(function() {
		...
		$("#sortable").sortable({ 
			...
			var order = $(this).sortable("serialize")+ '&gallery=<?php echo $gallery;  ?>';
				...
				$.post("includes/gal-sort.php", order, function(theResponse){
...
<div class="howto">
	...
	<p><b>Slider</b></p>
	<input value='&lt;?php $gallery ="<?php if(!empty($_GET["g"])) echo htmlentities($_GET["g"]); ?>"; include("<?php echo $pulse_dir; ?>/includes/<?php echo 'gallery.php'; ?>"); ?&gt;' onClick="select_all(this)" >             
	<p><b>Thumbnail Gallery</b></p>
	<input value='&lt;?php $gallery ="<?php if(!empty($_GET["g"])) echo htmlentities($_GET["g"]); ?>"; include("<?php echo $pulse_dir; ?>/includes/<?php echo 'gallery2.php'; ?>"); ?&gt;' onClick="select_all(this)" >             
